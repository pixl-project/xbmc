...
namespace JSONRPC
{
  ...
  const char* const JSONRPC_SERVICE_TYPES[] = {
    ...
    "\"Addon.Types\": {"
      ...
      "\"enum\": [ \"unknown\", \"xbmc.metadata.scraper.albums\", \"xbmc.metadata.scraper.artists\", \"xbmc.metadata.scraper.movies\","
                ...
                "\"xbmc.pvrclient\", \"xbmc.addon.video\", \"xbmc.addon.audio\", \"xbmc.addon.image\", \"xbmc.addon.game\","
                "\"xbmc.addon.executable\", \"xbmc.service\", \"xbmc.subtitle.module\", \"xbmc.gameclient\" ],"
      "\"default\": \"unknown\""
    "}",
    "\"Addon.Content\": {"
      "\"type\": \"string\","
  ...
  const char* const JSONRPC_SERVICE_METHODS[] = {
    ...
    "\"Input.ShowOSD\": {"
      ...
      "\"returns\": \"string\""
    "}",
    "\"Input.SetJoypadState\": {"
      "\"type\": \"method\","
      "\"description\": \"Do an action in RetroPlayer\","
      "\"transport\": \"Response\","
      "\"permission\": \"Navigate\","
      "\"params\": ["
        "{ \"name\": \"joypad_id\", \"type\": \"integer\", \"required\": true },"
        "{ \"name\": \"button_id\", \"type\": \"integer\", \"required\": true },"
        "{ \"name\": \"button_down\", \"type\": \"boolean\", \"required\": true },"
        "{ \"name\": \"action_id\", \"type\": \"integer\", \"required\": true }"
      "],"
      "\"returns\": \"string\""
    "}",
